...
public class fac_complaint extends AppCompatActivity {
    ...
    Button add_compliant;
    EditText enter_compl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_compliant=findViewById(R.id.add_compl);
        enter_compl=findViewById(R.id.complaint_box);
        add_compliant.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Create a new user with a first, middle, and last name
                Map<String, Object> user = new HashMap<>();
                user.put("enter_complaint",enter_compl.getText().toString());


// Add a new document with a generated ID
                FirebaseFirestore db = FirebaseFirestore.getInstance();
                db.collection("complaint_fac")
                        .add(user)
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            @Override
                            public void onSuccess(DocumentReference documentReference) {
                                Log.d("complaint_fac", "DocumentSnapshot added with ID: " + documentReference.getId());
                                enter_compl.setText("");
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Log.w("complaint_fac", "Error adding document", e);
                            }
                        });
